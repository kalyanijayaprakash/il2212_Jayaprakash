...
altera_avalon_fifo_write_fifo(FIFO_1_IN_BASE,FIFO_1_IN_CSR_BASE, 0x103CF8);	
...
altera_avalon_fifo_write_fifo( FIFO_1_IN_BASE, FIFO_1_IN_CSR_BASE, 0x4 );
